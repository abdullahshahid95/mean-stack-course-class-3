function getOrder() {
    ...
    do {
        ...
        //================Men Menu===========================//
        if (categoryChoice == 1) {
            var menCategory = parseInt(prompt("Select Men category.\n"
                + "0. For no item\n"
                + "1. T.shirts\n"
                + "2. Jeans\n"
                + "3. Watches"));
            if (menCategory != 0) {
                if (menCategory == 1) {
                    var menShirt = prompt("Select Men T.shirt."
                    ...
                    if (menShirt != "0") {
                        var choiceArray = menShirt.split(",");
                        choiceArray.forEach(function (element) {
                    ...
                    var menJeans = prompt("Select Men Jeans."
                        + " Separate multiple choices with comma.\n"
                        + "0. For no item\n"
                    ...
                    if (menJeans != "0") {
                        var choiceArray = menJeans.split(",");
                        choiceArray.forEach(function (element) {
                    ...
                    var menWatch = prompt("Select Men Watches."
                        + " Separate multiple choices with comma.\n"
                        + "0. For no item\n"
                    ...
                    if (menWatch != "0") {
                        var choiceArray = menWatch.split(",");
                        choiceArray.forEach(function (element) {
        ...
        //================Women Menu===========================//
        if (categoryChoice == 2) {
            var womenCategory = parseInt(prompt("Select Women items' category.\n"
                + "0. For no item\n"
                + "1. Shirts\n"
                + "2. Jeans\n"
                + "3. Watches"));
            if (womenCategory != 0) {
                if (womenCategory == 1) {
                    var womenShirt = prompt("Select women Shirts."
                        + " Separate multiple choices with comma.\n"
                        + "0. For no item\n"
                        + "1. Round neck Rs 1300\n"
                        + "2. V neck Rs 800\n"
                        ...
                        + "4. Collor Front Button Rs 1000");
                    if (womenShirt != "0") {
                        var choiceArray = womenShirt.split(",");
                        choiceArray.forEach(function (element) {
                    ...
                    var womenJeans = prompt("Select women Jeans."
                        + " Separate multiple choices with comma.\n"
                        + "0. For no item\n"
                        + "1. Multicolor Denim Rs 1900\n"
                        + "2. Slim Fit Za Blue Rs 2400\n"
                        ...
                        + "4. Regular Fit Za Blue Rs 2400");
                    if (womenJeans != "0") {
                        var choiceArray = womenJeans.split(",");
                        choiceArray.forEach(function (element) {
                    ...
                    var womenWatch = prompt("Select Men Watches."
                        + " Separate multiple choices with comma.\n"
                        + "0. For no item\n"
                        + "1. Fitness Tracker Rs 2499\n"
                        + "2. Quartz White Dial Rs 2199\n"
                        ...
                        + "4. GSM Bluetooth Smart Rs 1499");
                    if (womenWatch != "0") {
                        var choiceArray = womenWatch.split(",");
                        choiceArray.forEach(function (element) {
        ...
        if (categoryChoice == 3) {
            var homeCategory = parseInt(prompt("Select Home Appliances category.\n"
                + "0. For no item\n"
                + "1. Kitchen Set\n"
                + "2. Iron\n"));
            if (homeCategory != 0) {
                if (homeCategory == 1) {
                    var homeKitchen = prompt("Select " + homeMenu[0][0].category + "."
                        + " Separate multiple choices with comma."
                        + "\n0. For no item"
                    ...
                    if (homeKitchen != "0") {
                        var choiceArray = homeKitchen.split(",");
                        choiceArray.forEach(function (element) {
                    ...
                    var homeIron = prompt("Select " + homeMenu[1][0].category + "."
                        + " Separate multiple choices with comma.\n"
                        + "0. For no item\n"
                    ...
                    if (homeIron != "0") {
                        var choiceArray = homeIron.split(",");
                        choiceArray.forEach(function (element) {
        ...
        //================Books Menu===========================//
        if (categoryChoice == 4) {
            var bookCategory = parseInt(prompt("Select Books category.\n"
                + "0. For no item\n"
                + "1. Novels\n"
                + "2. Cooking\n"));
            if (bookCategory != 0) {
                if (bookCategory == 1) {
                    var bookNovel = prompt("Select " + bookMenu[0][0].category + "."
                        + " Separate multiple choices with comma."
                        + "\n0. For no item"
                    ...
                    if (bookNovel != "0") {
                        var choiceArray = bookNovel.split(",");
                        choiceArray.forEach(function (element) {
                    ...
                    var bookCooking = prompt("Select " + bookMenu[1][0].category + "."
                        + " Separate multiple choices with comma.\n"
                        + "0. For no item\n"
                    ...
                    if (bookCooking != "0") {
                        var choiceArray = bookCooking.split(",");
                        choiceArray.forEach(function (element) {
    ...
    if (order.length > 0) {
        order.forEach(function (oElement) {
            if (oElement.length > 0) {
                oElement.forEach(function (element) {
